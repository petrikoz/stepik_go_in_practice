// https://stepik.org/lesson/526881/step/3?unit=519600
...
// echo "{100 10} [10 -50 20]" | go run step_3.go
// echo "{30 0} [-20 -10]" | go run step_3.go
// echo "{30 0}, [-20 -10 -10]" | go run step_3.go
// echo "{30 0}, [-100]" | go run step_3.go
// echo "{0 0}, [10 20 30]" | go run step_3.go
// echo "{0 0}, [10 -10 20 -20]" | go run step_3.go
// echo "{20 10}, [-20 -10]" | go run step_3.go
// echo "{20 10}, [-20 -10 -10]" | go run step_3.go
// echo "{0 100}, [-20 -10]" | go run step_3.go
// echo "{0 30}, [-20 -10]" | go run step_3.go
// echo "{0 30}, [-20 -10 -10]" | go run step_3.go
// echo "{70 30}, [-100 100]" | go run step_3.go
// echo "{100 10}, [10 0 20]" | go run step_3.go
